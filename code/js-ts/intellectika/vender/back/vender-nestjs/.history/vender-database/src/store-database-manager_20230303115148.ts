...
export class StoreDatabaseManager {
    ...
    public addProduct(product: Product) {
        this.performOperation(() => {
            ...
            if (existingRating != false) {
                ...
                newProductRating.products.push(product)
                this.addRating(newProductRating)
            }
    ...
    public getAllProducts(): IProduct[] {
        let repositoryCount: number =  this.productRepository.count()
        console.log('get all products count returned: ')
