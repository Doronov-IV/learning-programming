...
namespace MainEntityProject.Model.Context
{
    public class OwnedPropertyInheritanceContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            string _connectionString = config.GetConnectionString("OwnedPropertyInheritance");
        ...
        /// </summary>
        public OwnedPropertyInheritanceContext()
        {
        ...
        /// </param>
        public OwnedPropertyInheritanceContext(DbContextOptions<VehicleDatabaseContext> options) : base(options)
        {
