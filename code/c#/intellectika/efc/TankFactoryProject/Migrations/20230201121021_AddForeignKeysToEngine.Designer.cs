...
namespace TankFactoryProject.Migrations
{
    ...
    [Migration("20230201121021_AddForeignKeysToEngine")]
    partial class AddForeignKeysToEngine
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TankFactory.Model.Entities.Engine", b =>
                {
                    b.HasOne("TankFactory.Model.Entities.Manufacturer", "ManufacturerReference")
                        .WithOne()
                        .HasForeignKey("TankFactory.Model.Entities.Engine", "ManufacturerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TankFactory.Model.Entities.Price", "PriceReference")
                        .WithOne()
                        .HasForeignKey("TankFactory.Model.Entities.Engine", "PriceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
