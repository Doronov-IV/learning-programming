...
namespace Streamlet.Forms
{
    ...
    public partial class PrimaryForm : Form
    {
        ...
        2.  Неправильный ввод в адресную строку не вызывает ошибки, вместо этого он просто стирает неправильный ввод.
           Можно было бы сделать ошибку без труда, просто текущий вариант чуть больше похож на настоящий проводник;

        3.  Если долго ковыряться в коде, можно найти лишние 'ListView'. Это потому что файлы несколько раз
